...
namespace Pinwheel.Griffin
{
    public static partial class GEditorCommon
    {
        ...
        public static void DrawAffLinks(string text, string url, string utmCampaign = "", string utmSource = "", string utmMedium = "")
        {
            DrawAffLinks(text, new string[] { url }, utmCampaign, utmSource, utmMedium);
        }

        public static void DrawAffLinks(string text, string[] urls, string utmCampaign = "", string utmSource = "", string utmMedium = "")
        {
