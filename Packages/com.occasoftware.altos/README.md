...
IMPORTANT NOTE: Due to a Unity bug in backwards compatiblity of the VFXGraph, the VFXGraph files located in ""Packages/Altos/Visual Effects"" may not work.
We have added a script "VFXGraphAutoSwitcher", that looks which version of the VFXGraph files are in the "Visual Effects" folder and tries to update them accordingly.
If this goes wrong, you can try deleting the VFXGraphAutoSwitcher script (located in ""Packages/Altos/Visual Effects/Editor"") and manually replacing the 6 VFXGraph files from the ""Unity 6"" or ""Unity 2022"" folder
Use ""Unity 6"" if you are using Unity 6 or newer, use the ""Unity 2022"" folder for older versions.
Copy the files into the Visual Effects folder and remove the .txt extension, fully overwriting the ones already in place.
If you need help, don't hesitate to contact us at support@occasoftware.com!
